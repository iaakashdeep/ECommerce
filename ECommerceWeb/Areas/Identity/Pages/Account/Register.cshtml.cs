...
namespace ECommerceWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            //The above if condition is checking whether the role exist in DB if not we are inserting those roles.

            //Below logic is to fill the roles dropdown list
            Input = new()
            {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Below if condition is for adding the role along with the user
        ...
        private ApplicationUsers CreateUser()
        {
            try
            {
                ...
                //By default this will create an IdentityUser now, to make a user as ApplicationUser we have to change here
                //also we have to change the return type of this method from IdentityUser to ApplicationUsers
